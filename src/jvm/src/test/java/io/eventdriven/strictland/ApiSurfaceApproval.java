 ...
 * approval tool. The approved file is named {@code <TestClass>.<testMethod>.approved.txt}.
 */
@NullMarked
final class ApiSurfaceApproval {
    ...
    static void verify(String surface) {
        ...
        var approved = sourceDir.resolve(testClass.getSimpleName() + "." + caller.getMethodName() + ".approved.txt");
