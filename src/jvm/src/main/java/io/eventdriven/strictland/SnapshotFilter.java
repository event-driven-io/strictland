 ...
 * the short name laid out as {@link SnapshotLocation} lays out its folder, and a {@code namePrefix}
 * every variant's file name starts with.
 *
 * <p>This is a family read, a prefix match across every variant. Reading one named variant is instead an
 * exact location read against a resolved {@link SnapshotLocation}.</p>
 *
...
public record SnapshotFilter(List<String> path, String namePrefix) {
     ...
     * namespace, leaving its path as just the short name.
     *
